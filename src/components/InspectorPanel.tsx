...
// Placeholder for two tabs: "Attributes" and "Style & Icon"
const InspectorPanel = () => {
  ...
  return (
    <aside className="h-full w-80 p-6 border-l border-border bg-card rounded-r-lg shadow-md flex flex-col gap-4 animate-fade-in transition-all duration-300">
      ...
      <div className="pt-3 border-t border-border">
        <span className="text-xs text-muted-foreground">Style & Icon – <span className="italic">Coming soon</span></span>
      </div>
    </aside>
  );
};
