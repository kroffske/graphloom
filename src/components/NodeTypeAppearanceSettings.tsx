...
export default function NodeTypeAppearanceSettings() {
  ...
  React.useEffect(() => {
    ...
    setIconOrder((curr) => {
      ...
      return [...curr.filter((k) => iconKeys.includes(k)), ...toAdd];
    });
            ...
            <div
              ...
              onDrop={(e) => {
                ...
                if (dragIndex !== null && dragIndex !== idx) {
                  setOrder((old) => reorder(old, dragIndex, idx));
                  setDragIndex(null);
  ...
  return (
    <section className="border border-border rounded-lg bg-card shadow p-5 flex flex-col gap-4 mt-2 w-full">
